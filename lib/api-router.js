...
function apiRouter(io, event) {
     ...
     * - this.broadcast(event,params) : to broadcast an event with its params
     * 
     */
     ...
     * 
     * Thanks to this object, the api code will have access to the connected user object and broadcast function.
     * 
     */
